"""
This module implements the Z2 Lattice Gauge Theory.
"""
...
def z2_op(op_struct_ptr, op_str, ind, nlinks, args):
    """
    ...
    # U = |+><-| + |-><+| = Udag ('u' or 'U')
    # V = |-><-| - |+><+| = Vdag ('v' or 'V')
    if op_str == 85 or op_str == 117:  # u or U
        # it flips the state
        op_struct.state ^= b
    elif op_str == 86 or op_str == 118:  # v or V
        # +1 for |->, -1 for |+>
